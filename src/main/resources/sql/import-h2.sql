...
VALUES ('Pan Tadeusz', 'Adam Mickiewicz', 1, 35.75);
INSERT INTO PRODUCT (name, description, quantity, price)
VALUES ('Krzyzacy', 'Henryk Sienkiewicz', 5, 34.50);
INSERT INTO PRODUCT (name, description, quantity, price)
VALUES ('Harry Potter', 'J.K. Rowling', 3, 1500.00);
INSERT INTO PRODUCT (name, description, quantity, price)
VALUES ('Wesele', 'Stanislaw Wyspianski', 40, 1000.00);
INSERT INTO PRODUCT (name, description, quantity, price)
VALUES ('Ogniem i mieczem', 'Henryk Sienkiewicz', 80, 45.45);
